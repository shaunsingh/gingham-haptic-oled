...
LT(LOWER, KC_ESC),KC_A,     KC_S,     KC_D,  KC_F,  KC_G,  KC_H,    KC_J,  KC_K,  KC_L,     KC_SCLN,  KC_QUOT,           KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,  KC_C,  KC_V,  KC_B,    KC_N,  KC_M,  KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_RSFT,
        KC_LCTL,  KC_LALT,  KC_LGUI,                       LT(LOWER, KC_SPC),               KC_RGUI,  LOWER,    RAISE,   ADJUST),
...
void keyboard_post_init_user(void) {
  ...
  #if HAPTIC_ENABLE
    haptic_enable(); // enables per key haptic feedback by default
  #endif //HAPTIC ENABLE
}
